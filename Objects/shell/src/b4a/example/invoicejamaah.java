...
public static b4a.example.webview _webview = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",invoicejamaah.mostCurrent._activity,"BtnConfirm",invoicejamaah.mostCurrent._btnconfirm,"CodeSemua",Debug.moduleToString(b4a.example.codesemua.class),"DonationJamaah",Debug.moduleToString(b4a.example.donationjamaah.class),"DonationJamaahDetail",Debug.moduleToString(b4a.example.donationjamaahdetail.class),"DonationStewardship",Debug.moduleToString(b4a.example.donationstewardship.class),"HistoryJamaah",Debug.moduleToString(b4a.example.historyjamaah.class),"HomeJamaah",Debug.moduleToString(b4a.example.homejamaah.class),"HomeStewardship",Debug.moduleToString(b4a.example.homestewardship.class),"HttpUtils2Service",invoicejamaah.mostCurrent._httputils2service,"Label1",invoicejamaah.mostCurrent._label1,"Label10",invoicejamaah.mostCurrent._label10,"Label12",invoicejamaah.mostCurrent._label12,"Label2",invoicejamaah.mostCurrent._label2,"Label4",invoicejamaah.mostCurrent._label4,"Label5",invoicejamaah.mostCurrent._label5,"Label6",invoicejamaah.mostCurrent._label6,"Label7",invoicejamaah.mostCurrent._label7,"Label8",invoicejamaah.mostCurrent._label8,"Main",Debug.moduleToString(b4a.example.main.class),"MainScroll",invoicejamaah.mostCurrent._mainscroll,"MapsJamaah",Debug.moduleToString(b4a.example.mapsjamaah.class),"NavbarTitle",invoicejamaah.mostCurrent._navbartitle,"Note",invoicejamaah.mostCurrent._note,"OrphansJamaah",Debug.moduleToString(b4a.example.orphansjamaah.class),"OrphansJamaahDetail",Debug.moduleToString(b4a.example.orphansjamaahdetail.class),"PanelPaidInfo",invoicejamaah.mostCurrent._panelpaidinfo,"PanelQurban",invoicejamaah.mostCurrent._panelqurban,"PoorJamaah",Debug.moduleToString(b4a.example.poorjamaah.class),"PoorJamaahDetail",Debug.moduleToString(b4a.example.poorjamaahdetail.class),"QurbanJamaah",Debug.moduleToString(b4a.example.qurbanjamaah.class),"QurbanJamaahDetail",Debug.moduleToString(b4a.example.qurbanjamaahdetail.class),"QurbanStewardship",Debug.moduleToString(b4a.example.qurbanstewardship.class),"QurbanStewardshipDetail",Debug.moduleToString(b4a.example.qurbanstewardshipdetail.class),"Starter",Debug.moduleToString(b4a.example.starter.class),"Starter2",Debug.moduleToString(b4a.example.starter2.class),"TpaJamaah",Debug.moduleToString(b4a.example.tpajamaah.class),"TpaJamaahDetail",Debug.moduleToString(b4a.example.tpajamaahdetail.class),"WebView",Debug.moduleToString(b4a.example.webview.class)};
}
}