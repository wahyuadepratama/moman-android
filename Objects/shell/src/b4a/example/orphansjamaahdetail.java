...
public class orphansjamaahdetail implements IRemote{
	public static orphansjamaahdetail mostCurrent;
	public static RemoteObject processBA;
    public static boolean processGlobalsRun;
    public static RemoteObject myClass;
    public static RemoteObject remoteMe;
	public orphansjamaahdetail() {
		mostCurrent = this;
	}
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("orphansjamaahdetail"), "b4a.example.orphansjamaahdetail");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, orphansjamaahdetail.class);
...
public static b4a.example.webview _webview = null;
  public Object[] GetGlobals() {
		return new Object[] {"account",orphansjamaahdetail.mostCurrent._account,"accountId",orphansjamaahdetail.mostCurrent._accountid,"Activity",orphansjamaahdetail.mostCurrent._activity,"Button1",orphansjamaahdetail.mostCurrent._button1,"CheckGuna",orphansjamaahdetail.mostCurrent._checkguna,"CheckHamba",orphansjamaahdetail.mostCurrent._checkhamba,"CodeSemua",Debug.moduleToString(b4a.example.codesemua.class),"DonationJamaah",Debug.moduleToString(b4a.example.donationjamaah.class),"DonationJamaahDetail",Debug.moduleToString(b4a.example.donationjamaahdetail.class),"DonationStewardship",Debug.moduleToString(b4a.example.donationstewardship.class),"EditTotal",orphansjamaahdetail.mostCurrent._edittotal,"HistoryJamaah",Debug.moduleToString(b4a.example.historyjamaah.class),"HomeJamaah",Debug.moduleToString(b4a.example.homejamaah.class),"HomeStewardship",Debug.moduleToString(b4a.example.homestewardship.class),"HttpUtils2Service",orphansjamaahdetail.mostCurrent._httputils2service,"InvoiceJamaah",Debug.moduleToString(b4a.example.invoicejamaah.class),"Main",Debug.moduleToString(b4a.example.main.class),"MainScroll",orphansjamaahdetail.mostCurrent._mainscroll,"MapsJamaah",Debug.moduleToString(b4a.example.mapsjamaah.class),"NavbarTitle",orphansjamaahdetail.mostCurrent._navbartitle,"noTransaction",orphansjamaahdetail.mostCurrent._notransaction,"OrphansJamaah",Debug.moduleToString(b4a.example.orphansjamaah.class),"PanelQurban",orphansjamaahdetail.mostCurrent._panelqurban,"pengurus",orphansjamaahdetail.mostCurrent._pengurus,"PoorJamaah",Debug.moduleToString(b4a.example.poorjamaah.class),"PoorJamaahDetail",Debug.moduleToString(b4a.example.poorjamaahdetail.class),"publicId",orphansjamaahdetail.mostCurrent._publicid,"QurbanJamaah",Debug.moduleToString(b4a.example.qurbanjamaah.class),"QurbanJamaahDetail",Debug.moduleToString(b4a.example.qurbanjamaahdetail.class),"QurbanStewardship",Debug.moduleToString(b4a.example.qurbanstewardship.class),"QurbanStewardshipDetail",Debug.moduleToString(b4a.example.qurbanstewardshipdetail.class),"SpinPengurus",orphansjamaahdetail.mostCurrent._spinpengurus,"Starter",Debug.moduleToString(b4a.example.starter.class),"Starter2",Debug.moduleToString(b4a.example.starter2.class),"TpaJamaah",Debug.moduleToString(b4a.example.tpajamaah.class),"TpaJamaahDetail",Debug.moduleToString(b4a.example.tpajamaahdetail.class),"WebView",Debug.moduleToString(b4a.example.webview.class)};
}
}