...
Debug.ShouldStop(536870912);
if (RemoteObject.solveBoolean("=",poorjamaahdetail.mostCurrent._spinpengurus.runMethod(true,"getSelectedIndex"),BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(_i),RemoteObject.createImmutable(1)}, "+",1, 1)))) { 
