...
public static RemoteObject _transaction = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static RemoteObject _jamaah = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static b4a.example.webview _webview = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",qurbanstewardship.mostCurrent._activity,"BtnDonationHere",qurbanstewardship.mostCurrent._btndonationhere,"CLV",qurbanstewardship.mostCurrent._clv,"CodeSemua",Debug.moduleToString(b4a.example.codesemua.class),"Date",qurbanstewardship.mostCurrent._date,"DonationJamaah",Debug.moduleToString(b4a.example.donationjamaah.class),"DonationJamaahDetail",Debug.moduleToString(b4a.example.donationjamaahdetail.class),"HistoryJamaah",Debug.moduleToString(b4a.example.historyjamaah.class),"HomeJamaah",Debug.moduleToString(b4a.example.homejamaah.class),"HomeStewardship",Debug.moduleToString(b4a.example.homestewardship.class),"HttpUtils2Service",qurbanstewardship.mostCurrent._httputils2service,"IDpro",qurbanstewardship.mostCurrent._idpro,"idSelected",qurbanstewardship._idselected,"idWorshipplace",qurbanstewardship._idworshipplace,"InvoiceJamaah",Debug.moduleToString(b4a.example.invoicejamaah.class),"Jamaah",qurbanstewardship.mostCurrent._jamaah,"Main",Debug.moduleToString(b4a.example.main.class),"MainScroll",qurbanstewardship.mostCurrent._mainscroll,"MapsJamaah",Debug.moduleToString(b4a.example.mapsjamaah.class),"NavbarTitle",qurbanstewardship.mostCurrent._navbartitle,"OrphansJamaah",Debug.moduleToString(b4a.example.orphansjamaah.class),"OrphansJamaahDetail",Debug.moduleToString(b4a.example.orphansjamaahdetail.class),"PanelListItem",qurbanstewardship.mostCurrent._panellistitem,"PanelQurban",qurbanstewardship.mostCurrent._panelqurban,"PoorJamaah",Debug.moduleToString(b4a.example.poorjamaah.class),"PoorJamaahDetail",Debug.moduleToString(b4a.example.poorjamaahdetail.class),"Qurban",qurbanstewardship.mostCurrent._qurban,"QurbanJamaah",Debug.moduleToString(b4a.example.qurbanjamaah.class),"QurbanJamaahDetail",Debug.moduleToString(b4a.example.qurbanjamaahdetail.class),"QurbanStewardshipDetail",Debug.moduleToString(b4a.example.qurbanstewardshipdetail.class),"Starter",Debug.moduleToString(b4a.example.starter.class),"Starter2",Debug.moduleToString(b4a.example.starter2.class),"Status",qurbanstewardship.mostCurrent._status,"TpaJamaah",Debug.moduleToString(b4a.example.tpajamaah.class),"TpaJamaahDetail",Debug.moduleToString(b4a.example.tpajamaahdetail.class),"Transaction",qurbanstewardship.mostCurrent._transaction,"WebView",Debug.moduleToString(b4a.example.webview.class),"xui",qurbanstewardship._xui};
}
}