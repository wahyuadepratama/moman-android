...
public static b4a.example.webview _webview = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",qurbanstewardshipdetail.mostCurrent._activity,"BtnConfirm",qurbanstewardshipdetail.mostCurrent._btnconfirm,"CodeSemua",Debug.moduleToString(b4a.example.codesemua.class),"DonationJamaah",Debug.moduleToString(b4a.example.donationjamaah.class),"DonationJamaahDetail",Debug.moduleToString(b4a.example.donationjamaahdetail.class),"HistoryJamaah",Debug.moduleToString(b4a.example.historyjamaah.class),"HomeJamaah",Debug.moduleToString(b4a.example.homejamaah.class),"HomeStewardship",Debug.moduleToString(b4a.example.homestewardship.class),"HttpUtils2Service",qurbanstewardshipdetail.mostCurrent._httputils2service,"InvoiceJamaah",Debug.moduleToString(b4a.example.invoicejamaah.class),"Label1",qurbanstewardshipdetail.mostCurrent._label1,"Label10",qurbanstewardshipdetail.mostCurrent._label10,"Label12",qurbanstewardshipdetail.mostCurrent._label12,"Label2",qurbanstewardshipdetail.mostCurrent._label2,"Label4",qurbanstewardshipdetail.mostCurrent._label4,"Label5",qurbanstewardshipdetail.mostCurrent._label5,"Label6",qurbanstewardshipdetail.mostCurrent._label6,"Label7",qurbanstewardshipdetail.mostCurrent._label7,"LabelDate",qurbanstewardshipdetail.mostCurrent._labeldate,"Main",Debug.moduleToString(b4a.example.main.class),"MainScroll",qurbanstewardshipdetail.mostCurrent._mainscroll,"MapsJamaah",Debug.moduleToString(b4a.example.mapsjamaah.class),"NavbarTitle",qurbanstewardshipdetail.mostCurrent._navbartitle,"OrphansJamaah",Debug.moduleToString(b4a.example.orphansjamaah.class),"OrphansJamaahDetail",Debug.moduleToString(b4a.example.orphansjamaahdetail.class),"PanelPaidInfo",qurbanstewardshipdetail.mostCurrent._panelpaidinfo,"PanelQurban",qurbanstewardshipdetail.mostCurrent._panelqurban,"PoorJamaah",Debug.moduleToString(b4a.example.poorjamaah.class),"PoorJamaahDetail",Debug.moduleToString(b4a.example.poorjamaahdetail.class),"QurbanJamaah",Debug.moduleToString(b4a.example.qurbanjamaah.class),"QurbanJamaahDetail",Debug.moduleToString(b4a.example.qurbanjamaahdetail.class),"QurbanStewardship",Debug.moduleToString(b4a.example.qurbanstewardship.class),"Starter",Debug.moduleToString(b4a.example.starter.class),"Starter2",Debug.moduleToString(b4a.example.starter2.class),"TpaJamaah",Debug.moduleToString(b4a.example.tpajamaah.class),"TpaJamaahDetail",Debug.moduleToString(b4a.example.tpajamaahdetail.class),"valueConfirmation",qurbanstewardshipdetail.mostCurrent._valueconfirmation,"valuePaid",qurbanstewardshipdetail.mostCurrent._valuepaid,"valuePaymentInfo",qurbanstewardshipdetail.mostCurrent._valuepaymentinfo,"valueStatus",qurbanstewardshipdetail.mostCurrent._valuestatus,"valueUnpaid",qurbanstewardshipdetail.mostCurrent._valueunpaid,"WebView",Debug.moduleToString(b4a.example.webview.class)};
}
}