...
views.get("label7").vw.setWidth((int)((92d / 100 * width) - ((5d / 100 * width))));
...
//BA.debugLineNum = 50;BA.debugLine="LblUnpaid.Height=5%y"[DetailQurbanConfirmation/General script]
views.get("lblunpaid").vw.setHeight((int)((5d / 100 * height)));
//BA.debugLineNum = 52;BA.debugLine="valueUnpaid.Top = LblUnpaid.Top"[DetailQurbanConfirmation/General script]
views.get("valueunpaid").vw.setTop((int)((views.get("lblunpaid").vw.getTop())));
//BA.debugLineNum = 53;BA.debugLine="valueUnpaid.Height=Label3.Height"[DetailQurbanConfirmation/General script]
views.get("valueunpaid").vw.setHeight((int)((views.get("label3").vw.getHeight())));
//BA.debugLineNum = 54;BA.debugLine="valueUnpaid.SetLeftAndRight(40%x,92%x)"[DetailQurbanConfirmation/General script]
views.get("valueunpaid").vw.setLeft((int)((40d / 100 * width)));
views.get("valueunpaid").vw.setWidth((int)((92d / 100 * width) - ((40d / 100 * width))));
//BA.debugLineNum = 56;BA.debugLine="LblPaid.Top = LblUnpaid.Top + LblUnpaid.Height"[DetailQurbanConfirmation/General script]
views.get("lblpaid").vw.setTop((int)((views.get("lblunpaid").vw.getTop())+(views.get("lblunpaid").vw.getHeight())));
//BA.debugLineNum = 57;BA.debugLine="LblPaid.SetLeftAndRight(5%x,40%x)"[DetailQurbanConfirmation/General script]
views.get("lblpaid").vw.setLeft((int)((5d / 100 * width)));
views.get("lblpaid").vw.setWidth((int)((40d / 100 * width) - ((5d / 100 * width))));
//BA.debugLineNum = 58;BA.debugLine="LblPaid.Height=5%y"[DetailQurbanConfirmation/General script]
views.get("lblpaid").vw.setHeight((int)((5d / 100 * height)));
//BA.debugLineNum = 60;BA.debugLine="valuePaid.Top = valueUnpaid.Top + valueUnpaid.Height"[DetailQurbanConfirmation/General script]
views.get("valuepaid").vw.setTop((int)((views.get("valueunpaid").vw.getTop())+(views.get("valueunpaid").vw.getHeight())));
//BA.debugLineNum = 61;BA.debugLine="valuePaid.Height=Label3.Height"[DetailQurbanConfirmation/General script]
views.get("valuepaid").vw.setHeight((int)((views.get("label3").vw.getHeight())));
//BA.debugLineNum = 62;BA.debugLine="valuePaid.SetLeftAndRight(40%x,92%x)"[DetailQurbanConfirmation/General script]
views.get("valuepaid").vw.setLeft((int)((40d / 100 * width)));
views.get("valuepaid").vw.setWidth((int)((92d / 100 * width) - ((40d / 100 * width))));
//BA.debugLineNum = 64;BA.debugLine="LblStatus.Top = LblPaid.Top + LblPaid.Height"[DetailQurbanConfirmation/General script]
views.get("lblstatus").vw.setTop((int)((views.get("lblpaid").vw.getTop())+(views.get("lblpaid").vw.getHeight())));
//BA.debugLineNum = 65;BA.debugLine="LblStatus.SetLeftAndRight(5%x,40%x)"[DetailQurbanConfirmation/General script]
views.get("lblstatus").vw.setLeft((int)((5d / 100 * width)));
views.get("lblstatus").vw.setWidth((int)((40d / 100 * width) - ((5d / 100 * width))));
//BA.debugLineNum = 66;BA.debugLine="LblStatus.Height=5%y"[DetailQurbanConfirmation/General script]
views.get("lblstatus").vw.setHeight((int)((5d / 100 * height)));
//BA.debugLineNum = 68;BA.debugLine="valueStatus.Top = valuePaid.Top + valuePaid.Height"[DetailQurbanConfirmation/General script]
views.get("valuestatus").vw.setTop((int)((views.get("valuepaid").vw.getTop())+(views.get("valuepaid").vw.getHeight())));
//BA.debugLineNum = 69;BA.debugLine="valueStatus.Height=Label3.Height"[DetailQurbanConfirmation/General script]
views.get("valuestatus").vw.setHeight((int)((views.get("label3").vw.getHeight())));
//BA.debugLineNum = 70;BA.debugLine="valueStatus.SetLeftAndRight(40%x,92%x)"[DetailQurbanConfirmation/General script]
views.get("valuestatus").vw.setLeft((int)((40d / 100 * width)));
views.get("valuestatus").vw.setWidth((int)((92d / 100 * width) - ((40d / 100 * width))));
//BA.debugLineNum = 72;BA.debugLine="LblPaymentInformation.Top = LblStatus.Top + LblStatus.Height"[DetailQurbanConfirmation/General script]
views.get("lblpaymentinformation").vw.setTop((int)((views.get("lblstatus").vw.getTop())+(views.get("lblstatus").vw.getHeight())));
//BA.debugLineNum = 73;BA.debugLine="LblPaymentInformation.SetLeftAndRight(5%x,40%x)"[DetailQurbanConfirmation/General script]
...
//BA.debugLineNum = 74;BA.debugLine="LblPaymentInformation.Height=5%y*2"[DetailQurbanConfirmation/General script]
views.get("lblpaymentinformation").vw.setHeight((int)((5d / 100 * height)*2d));
//BA.debugLineNum = 76;BA.debugLine="valuePaymentInfo.Top = valueStatus.Top + valueStatus.Height"[DetailQurbanConfirmation/General script]
views.get("valuepaymentinfo").vw.setTop((int)((views.get("valuestatus").vw.getTop())+(views.get("valuestatus").vw.getHeight())));
//BA.debugLineNum = 77;BA.debugLine="valuePaymentInfo.Height=Label3.Height*2"[DetailQurbanConfirmation/General script]
views.get("valuepaymentinfo").vw.setHeight((int)((views.get("label3").vw.getHeight())*2d));
//BA.debugLineNum = 78;BA.debugLine="valuePaymentInfo.SetLeftAndRight(40%x,92%x)"[DetailQurbanConfirmation/General script]
...
//BA.debugLineNum = 80;BA.debugLine="LblConfirmation.Top = LblPaymentInformation.Top + LblPaymentInformation.Height"[DetailQurbanConfirmation/General script]
...
//BA.debugLineNum = 81;BA.debugLine="LblConfirmation.SetLeftAndRight(5%x,40%x)"[DetailQurbanConfirmation/General script]
...
//BA.debugLineNum = 82;BA.debugLine="LblConfirmation.Height=5%y"[DetailQurbanConfirmation/General script]
views.get("lblconfirmation").vw.setHeight((int)((5d / 100 * height)));
//BA.debugLineNum = 84;BA.debugLine="valueConfirmation.Top = valuePaymentInfo.Top + valuePaymentInfo.Height"[DetailQurbanConfirmation/General script]
views.get("valueconfirmation").vw.setTop((int)((views.get("valuepaymentinfo").vw.getTop())+(views.get("valuepaymentinfo").vw.getHeight())));
//BA.debugLineNum = 85;BA.debugLine="valueConfirmation.Height=Label3.Height+2%y"[DetailQurbanConfirmation/General script]
views.get("valueconfirmation").vw.setHeight((int)((views.get("label3").vw.getHeight())+(2d / 100 * height)));
//BA.debugLineNum = 86;BA.debugLine="valueConfirmation.SetLeftAndRight(40%x,92%x)"[DetailQurbanConfirmation/General script]
...
//BA.debugLineNum = 88;BA.debugLine="PanelWorshipPlace.Top = 2%y + PanelInvoice.Top+PanelInvoice.Height"[DetailQurbanConfirmation/General script]
...
//BA.debugLineNum = 89;BA.debugLine="PanelWorshipPlace.SetLeftAndRight(3%x,97%x)"[DetailQurbanConfirmation/General script]
...
//BA.debugLineNum = 90;BA.debugLine="PanelWorshipPlace.Height=(Label3.Top*2) + Label3.Height"[DetailQurbanConfirmation/General script]
views.get("panelworshipplace").vw.setHeight((int)(((views.get("label3").vw.getTop())*2d)+(views.get("label3").vw.getHeight())));
//BA.debugLineNum = 92;BA.debugLine="PanelAnimalPrice.Top = PanelWorshipPlace.Top+PanelWorshipPlace.Height"[DetailQurbanConfirmation/General script]
views.get("panelanimalprice").vw.setTop((int)((views.get("panelworshipplace").vw.getTop())+(views.get("panelworshipplace").vw.getHeight())));
//BA.debugLineNum = 93;BA.debugLine="PanelAnimalPrice.SetLeftAndRight(3%x,97%x)"[DetailQurbanConfirmation/General script]
...
//BA.debugLineNum = 94;BA.debugLine="PanelAnimalPrice.Height=(Label3.Top) + Label3.Height"[DetailQurbanConfirmation/General script]
views.get("panelanimalprice").vw.setHeight((int)(((views.get("label3").vw.getTop()))+(views.get("label3").vw.getHeight())));
//BA.debugLineNum = 96;BA.debugLine="PanelLabelAnimal.Top = 2%y + PanelAnimalPrice.Top+PanelAnimalPrice.Height"[DetailQurbanConfirmation/General script]
...
//BA.debugLineNum = 97;BA.debugLine="PanelLabelAnimal.SetLeftAndRight(3%x,97%x)"[DetailQurbanConfirmation/General script]
...
//BA.debugLineNum = 98;BA.debugLine="PanelLabelAnimal.Height=(Label3.Top*2) + Label3.Height"[DetailQurbanConfirmation/General script]
views.get("panellabelanimal").vw.setHeight((int)(((views.get("label3").vw.getTop())*2d)+(views.get("label3").vw.getHeight())));
//BA.debugLineNum = 100;BA.debugLine="PanelTotalOrder.Top = PanelLabelAnimal.Top+PanelLabelAnimal.Height"[DetailQurbanConfirmation/General script]
views.get("paneltotalorder").vw.setTop((int)((views.get("panellabelanimal").vw.getTop())+(views.get("panellabelanimal").vw.getHeight())));
//BA.debugLineNum = 101;BA.debugLine="PanelTotalOrder.SetLeftAndRight(3%x,97%x)"[DetailQurbanConfirmation/General script]
...
//BA.debugLineNum = 102;BA.debugLine="PanelTotalOrder.Height=(Label3.Top*2) + Label3.Height"[DetailQurbanConfirmation/General script]
views.get("paneltotalorder").vw.setHeight((int)(((views.get("label3").vw.getTop())*2d)+(views.get("label3").vw.getHeight())));
//BA.debugLineNum = 104;BA.debugLine="PanelLabelPayment.Top = 2%y + PanelTotalOrder.Top+PanelTotalOrder.Height"[DetailQurbanConfirmation/General script]
...
//BA.debugLineNum = 105;BA.debugLine="PanelLabelPayment.SetLeftAndRight(3%x,97%x)"[DetailQurbanConfirmation/General script]
...
//BA.debugLineNum = 106;BA.debugLine="PanelLabelPayment.Height=(Label3.Top*2) + Label3.Height"[DetailQurbanConfirmation/General script]
views.get("panellabelpayment").vw.setHeight((int)(((views.get("label3").vw.getTop())*2d)+(views.get("label3").vw.getHeight())));
//BA.debugLineNum = 108;BA.debugLine="PanelPaidInfo.Top = PanelLabelPayment.Top+PanelLabelPayment.Height"[DetailQurbanConfirmation/General script]
views.get("panelpaidinfo").vw.setTop((int)((views.get("panellabelpayment").vw.getTop())+(views.get("panellabelpayment").vw.getHeight())));
//BA.debugLineNum = 109;BA.debugLine="PanelPaidInfo.SetLeftAndRight(3%x,97%x)"[DetailQurbanConfirmation/General script]
views.get("panelpaidinfo").vw.setLeft((int)((3d / 100 * width)));
views.get("panelpaidinfo").vw.setWidth((int)((97d / 100 * width) - ((3d / 100 * width))));
//BA.debugLineNum = 110;BA.debugLine="PanelPaidInfo.Height=LblConfirmation.Top + LblConfirmation.Height + 2%y"[DetailQurbanConfirmation/General script]
views.get("panelpaidinfo").vw.setHeight((int)((views.get("lblconfirmation").vw.getTop())+(views.get("lblconfirmation").vw.getHeight())+(2d / 100 * height)));
//BA.debugLineNum = 112;BA.debugLine="Label11.Top = 2%y"[DetailQurbanConfirmation/General script]
views.get("label11").vw.setTop((int)((2d / 100 * height)));
//BA.debugLineNum = 113;BA.debugLine="Label11.SetLeftAndRight(5%x,40%x)"[DetailQurbanConfirmation/General script]
views.get("label11").vw.setLeft((int)((5d / 100 * width)));
views.get("label11").vw.setWidth((int)((40d / 100 * width) - ((5d / 100 * width))));
//BA.debugLineNum = 114;BA.debugLine="Label11.Height=5%y"[DetailQurbanConfirmation/General script]
views.get("label11").vw.setHeight((int)((5d / 100 * height)));
//BA.debugLineNum = 116;BA.debugLine="Label12.Top = Label11.Top"[DetailQurbanConfirmation/General script]
views.get("label12").vw.setTop((int)((views.get("label11").vw.getTop())));
//BA.debugLineNum = 117;BA.debugLine="Label12.Height=Label3.Height"[DetailQurbanConfirmation/General script]
views.get("label12").vw.setHeight((int)((views.get("label3").vw.getHeight())));
//BA.debugLineNum = 118;BA.debugLine="Label12.SetLeftAndRight(40%x,92%x)"[DetailQurbanConfirmation/General script]
views.get("label12").vw.setLeft((int)((40d / 100 * width)));
views.get("label12").vw.setWidth((int)((92d / 100 * width) - ((40d / 100 * width))));
//BA.debugLineNum = 120;BA.debugLine="Label1.SetLeftAndRight(35%x,90%x)"[DetailQurbanConfirmation/General script]
views.get("label1").vw.setLeft((int)((35d / 100 * width)));
views.get("label1").vw.setWidth((int)((90d / 100 * width) - ((35d / 100 * width))));
//BA.debugLineNum = 121;BA.debugLine="Label2.SetLeftAndRight(35%x,90%x)"[DetailQurbanConfirmation/General script]
views.get("label2").vw.setLeft((int)((35d / 100 * width)));
views.get("label2").vw.setWidth((int)((90d / 100 * width) - ((35d / 100 * width))));
//BA.debugLineNum = 122;BA.debugLine="LabelDate.SetLeftAndRight(35%x,90%x)"[DetailQurbanConfirmation/General script]
views.get("labeldate").vw.setLeft((int)((35d / 100 * width)));
views.get("labeldate").vw.setWidth((int)((90d / 100 * width) - ((35d / 100 * width))));
//BA.debugLineNum = 123;BA.debugLine="Label1.Top=2%y"[DetailQurbanConfirmation/General script]
views.get("label1").vw.setTop((int)((2d / 100 * height)));
//BA.debugLineNum = 124;BA.debugLine="Label1.Height=Label3.Height"[DetailQurbanConfirmation/General script]
views.get("label1").vw.setHeight((int)((views.get("label3").vw.getHeight())));
//BA.debugLineNum = 125;BA.debugLine="Label2.Top=Label1.Top+Label1.Height"[DetailQurbanConfirmation/General script]
views.get("label2").vw.setTop((int)((views.get("label1").vw.getTop())+(views.get("label1").vw.getHeight())));
//BA.debugLineNum = 126;BA.debugLine="Label2.Height=Label3.Height"[DetailQurbanConfirmation/General script]
views.get("label2").vw.setHeight((int)((views.get("label3").vw.getHeight())));
//BA.debugLineNum = 127;BA.debugLine="LabelDate.Top=Label2.Top+Label2.Height"[DetailQurbanConfirmation/General script]
views.get("labeldate").vw.setTop((int)((views.get("label2").vw.getTop())+(views.get("label2").vw.getHeight())));
//BA.debugLineNum = 128;BA.debugLine="LabelDate.Height=Label2.Height"[DetailQurbanConfirmation/General script]
views.get("labeldate").vw.setHeight((int)((views.get("label2").vw.getHeight())));
//BA.debugLineNum = 130;BA.debugLine="BtnConfirm.Top=PanelPaidInfo.Top+ PanelPaidInfo.Height+2%y"[DetailQurbanConfirmation/General script]
views.get("btnconfirm").vw.setTop((int)((views.get("panelpaidinfo").vw.getTop())+(views.get("panelpaidinfo").vw.getHeight())+(2d / 100 * height)));
//BA.debugLineNum = 131;BA.debugLine="PanelQurban.Height = BtnConfirm.Top+BtnConfirm.Height"[DetailQurbanConfirmation/General script]
