...
public class LS_listdonationconfirmation{
...
views.get("fundneed").vw.setTop((int)((views.get("projectname").vw.getTop())+(views.get("projectname").vw.getHeight())));
...
views.get("ldatetime").vw.setLeft((int)((5d / 100 * width)));
views.get("ldatetime").vw.setWidth((int)((89d / 100 * width) - ((5d / 100 * width))));
views.get("ldatetime").vw.setHeight((int)((views.get("worshipplace").vw.getHeight())));
views.get("ldatetime").vw.setTop((int)((views.get("worshipplace").vw.getTop())+(views.get("worshipplace").vw.getHeight())+(2d / 100 * height)));
