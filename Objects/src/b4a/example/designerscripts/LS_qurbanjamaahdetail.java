...
views.get("mosquename").vw.setLeft((int)((2d / 100 * width)));
views.get("mosquename").vw.setWidth((int)((98d / 100 * width) - ((2d / 100 * width))));
views.get("deadlinepayment").vw.setLeft((int)((2d / 100 * width)));
views.get("deadlinepayment").vw.setWidth((int)((98d / 100 * width) - ((2d / 100 * width))));
views.get("pnlpengurus").vw.setLeft((int)((2d / 100 * width)));
views.get("pnlpengurus").vw.setWidth((int)((98d / 100 * width) - ((2d / 100 * width))));
views.get("pnlpengurus").vw.setHeight((int)((views.get("spinpengurus").vw.getHeight())+(2d / 100 * height)));
views.get("mosquename").vw.setHeight((int)((views.get("edittext1").vw.getHeight())+(5d / 100 * height)));
views.get("deadlinepayment").vw.setHeight((int)((views.get("edittext1").vw.getHeight())));
views.get("mosquename").vw.setTop((int)((2d / 100 * height)));
views.get("deadlinepayment").vw.setTop((int)((views.get("mosquename").vw.getTop())+(views.get("mosquename").vw.getHeight())+(2d / 100 * height)));
views.get("pnlpengurus").vw.setTop((int)((views.get("deadlinepayment").vw.getTop())+(views.get("deadlinepayment").vw.getHeight())+(2d / 100 * height)));
...
views.get("spinpengurus").vw.setHeight((int)((views.get("mosquename").vw.getHeight())));
