...
Sub Activity_Create(FirstTime As Boolean)
	...
	NavbarTitle.Text = "Infaq Orphans"
			...
			Case "LoadData"
				Try
					...
					For i=0 To data_list.Size-1
						...
						CLV.Add(CreateItem(a.Get("id"), a.Get("name"), "Address : "&a.Get("address"), "Infaq for Orphans Available"),"")
...
Sub BtnDonationHere_Click
	...
	StartActivity(OrphansJamaahDetail)
End Sub